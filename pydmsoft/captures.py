...
green_underline = "00ff00-101010"  # 一条色素下化线
...
red_blood = "c33839-353535"  # D62829
...
if __name__ == '__main__':
    ...
    try:
        ...
        m_ret = dm.BindWindowEx(hwnds[0], "gdi", "windows", "windows",
                                "dx.mouse.position.lock.api|dx.mouse.position.lock.message", 0)
        # m_ret = dm.BindWindow(199608, "gdi", "windows", "windows" , 0)
        dm.SetWindowState(hwnds[0],1)
    ...
    dm.delay(1000)
    dm.CaptureJpg(0,0,880,660,"test11.png",60)
    dm.delay(100)
    dm.UnBindWindow()
    sys.exit()
