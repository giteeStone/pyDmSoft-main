...
class DM():
    ...
    def HotKey(self, pre_str, key_str):
        self.KeyDownChar(pre_str)
        self.Delays(100,200)
        self.KeyPressChar(key_str)
        self.Delays(100,200)
        self.KeyUpChar(pre_str)
        pass
...
if __name__ == "__main__":
    m_dm = DM(r"D:\\damo\\7.2410\\RegDll.dll",r"D:\\damo\\7.2410\\dm.dll")
    print(m_dm,type(m_dm))
    try:
        print(m_dm.Reg(r'jv965720b239b8396b1b7df8b768c919e86e10f',r'jn5gun14k4ep1y7'))
        # print(m_dm.KeyPressChar("a"))
        # print(m_dm.KeyPressChar("a"))
        # print(m_dm.KeyPressChar("a"))
        # print(m_dm.KeyPressChar("Enter"))
        #m=m_dm.Capture(2,2,222,222,"1.png")
        ptWnd = m_dm.GetPointWindow(440,340)
        m_dm.MoveTo(632,625)
        #m_dm.RightClick()
        m_ret = m_dm.BindWindow(592666,"normal","windows","windows",0)
        m_dm.KeyPressChar("F2")
        #m_dm.KeyPressChar("F1")
        print("m_ret:",ptWnd,m_ret)
